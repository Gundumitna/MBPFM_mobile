...
// export default SpentHistoryPage
...
const SpentHistoryPage = ({route, navigation}) => {
  ...
  const pan = useState(new Animated.ValueXY({x: 0, y: wp('130%')}))[0];
  ...
  const displayViewOpacity = viewOpacity.interpolate({
    inputRange: [0, 0.5, 1],
    outputRange: ['transparent', 'transparent', '#E7EDFD'],
    extrapolate: 'clamp',
  });
      ...
      <View style={{backgroundColor: 'white', flex: 1.1}}>
        ...
        <View style={styles.container}>
          <View style={styles.topHeader}>
            ...
            <View>
              <Text style={styles.heading}>Spent History</Text>
            </View>
          </View>
          <Animated.View
            style={{
              flexDirection: 'row',
              padding: hp('2%'),
              backgroundColor: displayViewOpacity,
              marginTop: 10,
            }}>
            <View style={{width: 45, height: 45}}>
              {route.params.data.merchantIcon != null &&
              route.params.data.merchantIcon != '' ? (
                <Image
                  style={{
                    maxWidth: '100%',
                    height: '100%',
                ...
                <Image
                  style={{maxWidth: '100%', height: '100%'}}
                  source={{
                    uri: global.baseURL + 'customer/' + route.params.data.icon,
                  }}></Image>
              )}
            </View>
            <View
            ...
            <View
              ...
              {route.params.data.merchantName != null &&
              route.params.data.merchantName != '' ? (
                <Text style={{}}>{route.params.data.merchantName}</Text>
              ) : (
                <Text style={{}}>{route.params.data.category}</Text>
              )}
              <Text
                style={{color: '#454F63', fontSize: 10, paddingRight: hp('2%')}}
                numberOfLines={2}>
